...
public class LargeCommitTest {
    ...
    public void testLargeCommit() {
        ...
        String largeValue = createLargeString('a', valueSizeMB << 20); // Efficiently create 50MB string
        ...
        PCollection<KV<String, Iterable<String>>> result =
                p.apply(Create.of(inputValues)) // Efficiently create PCollection
        ...
        PAssert.that(result)
                .satisfies(kvs -> {
                    ...
                    assertThat(outputKV.getValue(), Matchers.contains(largeValue, largeValue, largeValue, largeValue, largeValue));
                    return null;
                });
    ...
    // Efficiently create a large string of specified size
    ...
    // Generate KV pairs with a single key and large values
    private static List<KV<String, String>> generateKeyValuePairs(String key, String value, int count) {
