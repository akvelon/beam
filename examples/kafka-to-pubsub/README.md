...
This example also exists as Google Dataflow Template, see its [README.md](https://github.com/GoogleCloudPlatform/DataflowTemplates/blob/KafkaToPubsubTemplate/v2/kafka-to-pubsub/README.md) for more information.
...
_Note: The Kafka to Pub/Sub job supports SSL configuration with the certificate located only in GCS._
